...
const GetQuote = () => {
  ...
  return (
    <div>
      <div className="relative h-auto max-[1000px]:mb-11">
        <div className="getaquote-img1">
          <img src={quote} alt="cusp-quote" />
        </div>
        <div className="getaquote-img2">
          <img src={bghouse} className="" alt="" />
        </div>
        <div className="relative w-[60vw] max-[1100px]:w-full border rounded-xl bg-white border-[#FFAC0B] flex flex-col justify-center px-11 py-6  shadow-custom mt-[5%] max-[1000px]:mx-auto mb-[3%]">
          {isSubmitted ? (
                            ...
                            className={`flex gap-3 font-[600] rounded-full px-20 py-2 text-[16px] cursor-pointer 
                             ${
                               formData.connectionType === "Ongrid"
                                 ? "bg-[#004A9C] text-white"
                                 : "text-[#004A9C] bg-[#FFF7E7] hover:bg-[#004A9C] hover:text-white"
                             }`}
                            onClick={() => {
                              setFormData({
                                ...formData,
